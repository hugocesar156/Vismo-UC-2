    ...
    public class Tema
    {
        ...
        public void MudaTema()
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                con.Open();
                cn.CommandText = "UPDATE Preferencias SET modo = @modo WHERE codigoUsuario = @codigoUsuario";
                cn.Parameters.Add("modo", SqlDbType.Int).Value = modo;
                cn.Parameters.Add("codigoUsuario", SqlDbType.Int).Value = usuario.Codigo;
                cn.Connection = con;
        ...
        public void GetModo()
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                con.Open();
                cn.CommandText = "SELECT modo FROM Preferencias WHERE codigoUsuario = @codigoUsuario";
                cn.Parameters.Add("codigoUsuario", SqlDbType.Int).Value = usuario.Codigo;
                cn.Connection = con;
