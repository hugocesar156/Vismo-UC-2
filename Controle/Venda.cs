    ...
    public class Venda
    {
        ...
        public void Inserir()
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                con.Open();
                cn.CommandText = "INSERT INTO Venda VALUES (@data, @valor, @codigoUsuario, 0)";
        ...
        public DataSet Listar()
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                cn.CommandText = "SELECT codigo, data, valor FROM Venda WHERE codigoUsuario = @codigoUsuario " +
                  "AND cancela = 0 ORDER BY data DESC";
        ...
        public DataSet ListarCodigo()
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                cn.CommandText = "SELECT codigo, data, valor FROM Venda WHERE codigoUsuario = @codigoUsuario " +
                "AND codigo = @codigo AND cancela = 0";
        ...
        public DataSet ListarData(string data1, string data2)
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                cn.CommandText = "SELECT codigo, data, valor FROM Venda WHERE codigoUsuario = @codigoUsuario " +
                "AND data BETWEEN '"+ data1 +"' AND '"+ data2 +"' AND cancela = 0 ORDER BY data DESC";
        ...
        public void Cancelar()
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                con.Open();
                cn.CommandText = "UPDATE Venda SET cancela = 1 WHERE codigo = @codigo";
                cn.Parameters.Add("codigo", SqlDbType.Int).Value = codigo;
                cn.Connection = con;
