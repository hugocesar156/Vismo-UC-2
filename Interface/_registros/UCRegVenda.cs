...
namespace Vismo._registros
{
    public partial class UCRegVenda : UserControl
    {
        ...
        public UCRegVenda()
        {
            ...
            btnCancelar.BackColor = FrmPrincipal.Instance.PanelLeft.BackColor;
            btnRegistro.BackColor = FrmPrincipal.Instance.PanelLeft.BackColor;
        ...
        {
            if (MessageBox.Show("Cancelar venda?", "Confirmação", 
            MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    MessageBox.Show("Venda cancelada.", "Confirmação", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                {
                    MessageBox.Show("Não foi possível cancelar venda.\n" +
                    "Falha ao tentar se comunicar com o Banco de Dados.", "Aviso",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
